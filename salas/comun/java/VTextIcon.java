...
public class VTextIcon implements Icon, PropertyChangeListener {
	...
	public VTextIcon(Component component, String label) {
		this(component, label, ROTATE_DEFAULT,component.getForeground());
	}
	
	
	public VTextIcon(Component component, String label, int rotateHint) {
		this(component, label, rotateHint,component.getForeground());
	}	
	 ...
	 * @see #verifyRotation
	 */
 	public VTextIcon(Component component, String label, int rotateHint, Color colorTexto) {
    ...
    void calcDimensions() {
		...
		fWidth = 0; //MAXIMO: TRUCO PARA QUE NON SE FAGA MOI ANCHO
	}
   ...
   /**
    ...
    public void paintIcon(Component c, Graphics g, int x, int y) {
    	        x=x+7; //MAXIMO: TRUCO PARA QUE NON SE FAGA MOI ANCHO
