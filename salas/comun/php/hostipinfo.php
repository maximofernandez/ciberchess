...
class hostipinfo_class
{
	...
	Function GetIpLocation($ip,&$location)
	{
		...
		$uri="/get_html.php?ip=".UrlEncode($ip)."&position=true";
		...
		if($posicion1=strpos($entrada,"Latitude:"))
		{
		   $posicion1+=9;
		   $posicion2=strpos($entrada,"\n",$posicion1);
		   $location['LAT']=trim(substr($entrada,$posicion1,$posicion2-$posicion1));
		}
		else
		  $location['LAT']="";
		  
		if($posicion1=strpos($entrada,"Longitude:"))
		{
		   $posicion1+=10;
		   $location['LONG']=trim(substr($entrada,$posicion1));
		}
		else
		  $location['LONG']="";	
		  
		if($posicion1=strpos($entrada,"City:"))
		{
		   $posicion1+=5;
		   $posicion2=strpos($entrada,"\n",$posicion1);
		...
		if($posicion1=strpos($entrada,"Country:"))
		{
		   $posicion1+=8;
